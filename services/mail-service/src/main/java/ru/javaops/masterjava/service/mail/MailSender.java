...
public class MailSender {
    ...
    static String sendAttach(Set<Addressee> to, String subject, String body, String attachPath) throws WebStateException {
        ...
        try {
            ...
            attachment.setPath("C:\\windows-version.txt");
//            attachment.setPath(attachPath);
            attachment.setDisposition(EmailAttachment.ATTACHMENT);
            attachment.setDescription("Test desc");
            attachment.setName("windows-version.txt");
        ...
        try {
            MAIL_CASE_DAO.insert(MailCase.of(to, to, subject, state));
        } catch (Exception e) {
            log.error("Mail history saving exception", e);
            throw new WebStateException(e, ExceptionType.DATA_BASE);
        }
